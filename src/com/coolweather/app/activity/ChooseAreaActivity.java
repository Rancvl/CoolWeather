...
public class ChooseAreaActivity extends Activity{
	...
	protected void queryCities() {
		// TODO Auto-generated method stub
		cityList = coolWeatherDB.loadCitis(selectedProvince.getId());
		if(cityList.size() > 0) {
			dataList.clear();
		...
		HttpUtil.sendRequest(address, new HttpCallbackListener() {
			...
			public void onFinish(String response) {
				...
				if("province".equals(type)) {
					...
					result = Utilty.handleCityResponse(coolWeatherDB, response, selectedProvince.getId());
				} else if("county".equals(type)) {
					result = Utilty.handleCountyResponse(coolWeatherDB, response, selectedCity.getId());
				}
